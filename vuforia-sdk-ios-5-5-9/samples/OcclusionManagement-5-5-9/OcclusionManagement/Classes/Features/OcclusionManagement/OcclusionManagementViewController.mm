...
- (void)loadView
{
    ...
    self.title = @"Occlusion Management";
    ...
    OcclusionManagementAppDelegate *appDelegate = (OcclusionManagementAppDelegate*)[[UIApplication sharedApplication] delegate];
    ...
    // we set direction "up" instead of "right" as the view is rotated 90 deg
...
// didReceiveMemoryWarning is the right place were to remove observers.
// Alternatively, as a last resort, the dealloc method may be used too.
// NOTE: DO NOT use [viewDidUnload], as this is deprecated since iOS 6.
...
{
    // no menu option for this feature
    return false;
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue isKindOfClass:[PresentMenuSegue class]]) {
        ...
        if ([dest isKindOfClass:[SampleAppMenuViewController class]]) {
            ...
            menuVC.sampleAppFeatureName = @"Occlusion Management";
            menuVC.backSegueId = @"BackToOcclusionManagement";
