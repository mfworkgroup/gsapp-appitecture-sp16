...
- (void)viewDidLoad {
    ...
    secondfButton = [UIButton buttonWithType:UIButtonTypeSystem];
    secondfButton. frame = CGRectMake(20, 280, 200, 40);
    secondfButton.backgroundColor = [UIColor colorWithHue:0 saturation:0.57 brightness:0.87 alpha:1.0];
    secondfButton.titleLabel.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:24];
    [secondfButton setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];
    [secondfButton setTitle:@"200 Level" forState:UIControlStateNormal];
    ...
    thirdfButton = [UIButton buttonWithType:UIButtonTypeSystem];
    thirdfButton. frame = CGRectMake(20, 360, 200, 40);
    thirdfButton.backgroundColor = [UIColor colorWithHue:0 saturation:0.57 brightness:0.87 alpha:1.0];
    [thirdfButton setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];
    [thirdfButton setTitle:@"300 Level" forState:UIControlStateNormal];
    [thirdfButton addTarget:self action:@selector(cameraDevice) forControlEvents:UIControlEventTouchUpInside];
    thirdfButton.titleLabel.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:24];
    [self.view addSubview:thirdfButton];
   
    
    // 3. creating and setting buttons
    fourthfButton = [UIButton buttonWithType:UIButtonTypeSystem];
    fourthfButton. frame = CGRectMake(20, 420, 200, 40);
    fourthfButton.backgroundColor = [UIColor colorWithHue:0 saturation:0.57 brightness:0.87 alpha:1.0];
    [fourthfButton setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];
    [fourthfButton setTitle:@"400 Level" forState:UIControlStateNormal];
    [fourthfButton addTarget:self action:@selector(cameraDevice) forControlEvents:UIControlEventTouchUpInside];
    fourthfButton.titleLabel.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:24];
    [self.view addSubview:fourthfButton];
   
    
    // 4. creating and setting buttons
    sevenfButton = [UIButton buttonWithType:UIButtonTypeSystem];
    sevenfButton. frame = CGRectMake(20, 500, 200, 40);
    sevenfButton.backgroundColor = [UIColor colorWithHue:0 saturation:0.57 brightness:0.87 alpha:1.0];
    [sevenfButton setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];[sevenfButton setTitle:@"700 Level" forState:UIControlStateNormal];
    [sevenfButton addTarget:self action:@selector(cameraDevice) forControlEvents:UIControlEventTouchUpInside];
    sevenfButton.titleLabel.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:24];
