...
@synthesize overlayViewController, arViewController;
@synthesize parentView, splashView;
...
- (void) touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (2 == tc)
    {
        ...
        [[Vuforiautils getInstance] cameraCancelAF];
        [overlayViewController showOverlay];
    }
    if (1 == tc)
    {
        [[Vuforiautils getInstance] cameraTriggerAF];
    }
}
