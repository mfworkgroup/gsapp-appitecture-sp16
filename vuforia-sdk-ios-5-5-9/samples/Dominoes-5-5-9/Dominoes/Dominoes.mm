...
renderDominoes()
{
    ...
    // set the viewport
    Viewport viewport = [Vuforiautils getInstance].viewport;
    glViewport(viewport.posX, viewport.posY, viewport.sizeX, viewport.sizeY);
...
renderCube(float* transform)
{
    ...
    ShaderUtils::multiplyMatrix(&[Vuforiautils getInstance].projectionMatrix.data[0], &objectMatrix.data[0], &modelViewProjection.data[0]);
                          ...
                          Vuforia::Vec3F &intersection, Vuforia::Vec3F &lineStart, Vuforia::Vec3F &lineEnd)
{
    ...
    Vuforia::Matrix44F projectionMatrix = [Vuforiautils getInstance].projectionMatrix;
