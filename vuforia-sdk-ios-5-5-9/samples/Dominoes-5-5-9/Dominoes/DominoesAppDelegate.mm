...
/*
 ...
 The Vuforia sample apps are organised to work with standard iOS view
 controller life cycles.
 
 * Vuforiautils contains all the code that initialises and manages the Vuforia
 lifecycle plus some useful functions for accessing targets etc. This is a
 singleton class that makes Vuforia accessible from anywhere within the app.
 ...
 * ARViewController manages the lifecycle of the Camera and Augmentations,
 calling Vuforia:createAR, Vuforia:destroyAR, Vuforia:pauseAR and Vuforia:resumeAR
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[Vuforiautils getInstance] addTargetName:@"Stones" atPath:@"Stones.xml"];
