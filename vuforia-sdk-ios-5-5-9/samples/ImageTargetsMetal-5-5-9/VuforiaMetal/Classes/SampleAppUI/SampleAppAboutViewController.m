...
@property (weak, nonatomic) IBOutlet UISwitch *_uiSwitchBindVideoBackground;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self._uiSwitchBindVideoBackground.on = NO;
...
- (IBAction)onStartButton:(id)sender
{
    ...
    NSString *segueId = (self._uiSwitchBindVideoBackground.on) ? @"PushImageTargets(videobackground)" : @"PushImageTargets";
