...
@interface ImageTargetsMetalVideoBackgroundViewController : UIViewController <SampleApplicationControl, SampleAppMenuDelegate> {
...
@property (nonatomic, strong) ImageTargetsMetalVideoBackgroundView * metalView;
