...
#import "ImageTargetsMetalVideoBackgroundViewController.h"
...
@interface ImageTargetsMetalVideoBackgroundViewController ()
@property (weak, nonatomic) IBOutlet UIImageView *ARViewPlaceholder;
@end


@implementation ImageTargetsMetalVideoBackgroundViewController
...
- (void)loadView
{
    ...
    metalView = [[ImageTargetsMetalVideoBackgroundView alloc] initWithFrame:viewFrame appSession:vapp];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue isKindOfClass:[PresentMenuSegue class]]) {
        ...
        if ([dest isKindOfClass:[SampleAppMenuViewController class]]) {
            ...
            menuVC.backSegueId = @"BackToImageTargetsMetalVideoBackground";
