...
// ImageTargetsMetalMTLView is a subclass of UIView and conforms to the informal protocol
// UIGLViewProtocol
@interface ImageTargetsMetalVideoBackgroundView : UIView <UIGLViewProtocol> {
@private
