...
#import "ImageTargetsMetalVideoBackgroundView.h"
...
@interface ImageTargetsMetalVideoBackgroundView ()
@property (nonatomic) CGFloat contentScaleFactor;
@end

@implementation ImageTargetsMetalVideoBackgroundView
...
- (void)renderFrameVuforia
{
    ...
    if (Vuforia::Renderer::getInstance().updateVideoBackgroundTexture(&unit)) {
        ...
        // Draw the geometry
        [encoder drawPrimitives:MTLPrimitiveTypeTriangle vertexStart:0 vertexCount:6];        // ========== Vuforia tracking ==========
        ...
        for (int i = 0; i < state.getNumTrackableResults(); ++i) {
            ...
            // ********** We need a Metal compatible MVP matrix **********
